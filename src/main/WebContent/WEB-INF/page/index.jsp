			...
			<dl id="">
				...
				<dd>
					<ul>
						...
						<li><a data-href="${path }/dept/list" data-title="部门管理" href="javascript:void(0)">部门管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="">
				<dt>
					<i class="Hui-iconfont">&#xe620;</i> 客户关系管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
						<li><a data-href="${path }/clue/list" data-title="线索" href="javascript:void(0)">线索</a></li>
						<li><a data-href="${path }/clue/pool" data-title="线索池" href="javascript:void(0)">线索池</a></li>
						<li><a data-href="${path }/customer/list" data-title="客户" href="javascript:void(0)">客户</a></li>
						<li><a data-href="${path }/customer/pool" data-title="客户池" href="javascript:void(0)">客户池</a></li>
						<li><a data-href="${path }/contact/list" data-title="客户联系人" href="javascript:void(0)">客户联系人</a></li>
					</ul>
				</dd>
			</dl>
		</div>
