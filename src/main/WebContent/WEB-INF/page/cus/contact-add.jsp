...
<body>
		...
		<form class="form form-horizontal" id="form-contact-add">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<input type="text" class="input-text" autocomplete="off" value="" onclick="customer_select('选择客户','${path}/customer/select','600','400')" placeholder="" name="companyName" id="companyName">
				</div>
			</div>
			<div class="row cl">
	...
	<script type="text/javascript">
			...
			$("#form-contact-add").validate({
			    ...
			    submitHandler: function(form) {
			        ...
			        $(form).ajaxSubmit({
			            async: false,
			            type: 'post',
			            url: "${applicationScope.path }/contact/addAfter",
		...
		function customer_select(title,url,w,h){
			console.log("hello123");
			layer_show(title,url,w,h);
		}
		function setCompanyName(name,id){
			var $name = $("#companyName").val(name);
			var $id = $("#customerId").val(id);
		}
	</script>
	<!--/请在上方写此页面业务相关的脚本-->
</body>
