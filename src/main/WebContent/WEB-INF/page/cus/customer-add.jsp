	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-customer-add">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9"> 
					<span class="select-box" style="width:150px;">
					<select class="select" name="cusStatus" size="1">
						<option value="0" selected="selected">意向客户</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9"> 
					<span class="select-box" style="width:150px;">
					<select class="select" name="employees" size="1">
						<option value="0" selected="selected">10人以下</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9"> 
					<span class="select-box" style="width:150px;">
					<select class="select" name="rank" size="1">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9"> 
					<span class="select-box" style="width:150px;">
					<select class="select" name="trade" size="1">
						<option value="0" selected="selected">IT教育</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9"> 
					...
					<select class="select" name="role" size="1">
						<option value="0" selected="selected">决策人</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="remark1" name="remark1">
				</div>
			</div>
			<div class="row cl">
			...
			$("#form-customer-add").validate({
			    ...
			    submitHandler: function(form) {
			        ...
			        $(form).ajaxSubmit({
			            async: false,
			            type: 'post',
			            url: "${applicationScope.path }/customer/addAfter",
