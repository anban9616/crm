...
<article class="page-container">
	<form class="form form-horizontal" id="form-dept-edit">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${requestScope.dept.name }" placeholder="" id="" name="name">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>备注：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${requestScope.dept.remark }" placeholder="" id="" name="remark">
		</div>
	</div>
	<div class="row cl">
	...
	$("#form-dept-edit").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				async:false,
				type: 'post',
				url: "${applicationScope.path }/dept/editAfter",
